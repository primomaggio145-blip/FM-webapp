  ...
  <Modal title={title} onClose={onClose}>
    <div style={{padding:24,display:"flex",flexDirection:"column",gap:16,alignItems:"center",textAlign:"center"}}>
      ...
      <div>
        ...
        <p style={{fontSize:13,color:C.textMuted}}>{testo||description||"Questa azione è irreversibile."}</p>
      </div>
    </div>
...
const RicevutaModal = ({ entrata, student, config, onClose }) => {
  ...
  const intestatario = student?.nomeRicevuta?.trim() || student?.name || entrata.studentName || "—";
        ...
        <div style={{background:"#fff",border:`1px solid ${C.border}`,borderRadius:12,overflow:"hidden",
          ...
          <div style={{background:`linear-gradient(135deg,${C.goldBg},#fff)`,
            ...
            <div style={{textAlign:"right"}}>
              <div style={{fontSize:10,color:"#888",letterSpacing:"0.1em",textTransform:"uppercase"}}>Ricevuta n°</div>
          ...
          <div style={{padding:"12px 24px 16px",borderTop:"1px solid #eee",textAlign:"center"}}>
            ...
            <div style={{fontSize:10,color:"#aaa",marginTop:2}}>{cfg.nomeScuola} · {cfg.annoScolastico}</div>
          </div>
        </div>
    ...
    <div style={{display:"flex",flexDirection:"column",gap:22}}>
      ...
      <div className="st2" style={{display:"flex",flexDirection:"column",gap:14}} onKeyDown={handleKeyDown}>
        ...
        <AuthInput label="Password" type="password" icon="lock" value={password}
          ...
          error={err.password} placeholder="••••••••"/>
      </div>
      ...
      <div className="st5" style={{background:C.goldBg,border:`1px solid ${C.goldDim}40`,
        ...
        {Object.entries(DEMO).map(([em,u])=>(
          <button key={em} onClick={()=>{setEmail(em);setPassword(u.password);setErr({});}}
            ...
            <span style={{fontSize:10,color:C.textMuted}}>{u.ruolo} · {em}</span>
          </button>
        ))}
      </div>
    ...
    <div style={{display:"flex",flexDirection:"column",gap:22,alignItems:"center",textAlign:"center",paddingTop:20}}>
      ...
      <div style={{animation:"fadeUp .4s .1s ease both"}}>
        ...
        <p style={{fontSize:14,color:C.textMuted,lineHeight:1.7}}>
          La tua richiesta è stata inviata agli amministratori.<br/>
    ...
    <div style={{display:"flex",flexDirection:"column",gap:20}}>
      <div className="st1">
        ...
        <p style={{fontSize:13,color:C.textMuted,lineHeight:1.5}}>
          Compila il modulo. Un amministratore approverà la tua richiesta.
        </p>
      </div>
            ...
            <div key={i} style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:0}}
              ...
              {isHov && (
                <div style={{position:"absolute",background:C.surface2,border:`1px solid ${C.border}`,
                  ...
                  <div style={{color:C.green}}>↑ {fmtD(d.entr)}</div>
                  <div style={{color:C.red}}>↓ {fmtD(d.usc)}</div>
                </div>
              )}
        ...
        return (
          <div key={l.id} className="lesson-row"
            ...
            <div style={{textAlign:"right"}}>
              ...
              <div style={{fontSize:10,color:C.textDim}}>{l.durata}′</div>
            </div>
            {/* Indicatore */}
          ...
          <div key={a.id} className="alert-row" style={{display:"flex",alignItems:"center",gap:12,
            ...
            <div style={{flex:1,minWidth:0}}>
              <div style={{fontSize:12,fontWeight:500,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>
                {a.desc}
                {a.sogg && <span style={{color:C.textMuted,fontWeight:400}}> — {a.sogg}</span>}
              </div>
...
const AlertPanel = ({ allievi, lezioniOggi }) => {
  ...
  if(alerts.length===0) return (
    <div style={{display:"flex",alignItems:"center",gap:10,padding:"14px 16px",
      ...
      <span style={{fontSize:13,color:C.green,fontWeight:500}}>Nessun alert — tutto in ordine</span>
    </div>
  );
  return (
    <div style={{display:"flex",flexDirection:"column",gap:6}}>
            ...
            <>
              ...
              <div>
                ...
                <div style={{fontSize:12,color:C.textDim,marginBottom:12}}>
                  Simula la vista per ruolo diverso. In produzione il ruolo sarà assegnato dall'amministratore.
                </div>
            ...
            <>
              ...
              <section>
                ...
                <div style={{display:"flex",flexDirection:"column",gap:12}}>
                  ...
                  <SField label="Nota a piè di ricevuta"
                  ...
                  <div className="section" style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,overflow:"hidden"}}>
                    ...
                    <div style={{padding:"10px 18px",borderTop:`1px solid ${C.border}`}}>
                      <button onClick={()=>onNavigate("calendario")}
                        ...
                        <Ic n="calendar" size={12} stroke={C.gold}/>Apri calendario →
                      </button>
                    </div>
                  </div>
                )}
                  ...
                  <div className="section" style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,overflow:"hidden"}}>
                    ...
                    <div style={{padding:"10px 18px",borderTop:`1px solid ${C.border}`}}>
                      <button onClick={()=>onNavigate("contabilita")}
                        style={{background:"none",border:"none",cursor:"pointer",fontSize:12,color:C.gold,fontFamily:"'DM Sans',sans-serif",display:"flex",alignItems:"center",gap:5}}>
                        <Ic n="euro" size={12} stroke={C.gold}/>Apri contabilità →
                      </button>
                    </div>
                  </div>
                )}
                ...
                {isVisible("alert") && (
                  <div className="section" style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,overflow:"hidden"}}>
                    ...
                    <div style={{padding:"10px 18px",borderTop:`1px solid ${C.border}`}}>
                      <button onClick={()=>onNavigate("allievi")}
                        style={{background:"none",border:"none",cursor:"pointer",fontSize:12,color:C.gold,fontFamily:"'DM Sans',sans-serif",display:"flex",alignItems:"center",gap:5}}>
                        <Ic n="users" size={12} stroke={C.gold}/>Gestisci allievi →
                      </button>
                    </div>
                  </div>
                )}
                {isVisible("attivita") && (
                  <div className="section" style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,overflow:"hidden"}}>
                    <div style={{padding:"14px 18px",borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",gap:8}}>
                      ...
                      <span style={{fontSize:12,fontWeight:500,letterSpacing:"0.06em",textTransform:"uppercase",color:C.textMuted}}>Attività recente</span>
                    </div>
  ...
  return (
    <>
      <div style={{padding:24,display:"flex",flexDirection:"column",gap:16}}>
        <Input label="Nome del corso *" value={f.name} onChange={e=>set("name",e.target.value)} error={err.name} placeholder="Es. Teoria avanzata, Coro voci bianche..."/>
        <div>
          <label style={{fontSize:12,color:C.textMuted,letterSpacing:"0.06em",textTransform:"uppercase",display:"block",marginBottom:8}}>Tipo corso</label>
          <div style={{display:"flex",gap:12}}>
            {[["individuale","solo","Individuale","1 allievo per lezione",C.gold,"#2e2308",C.goldDim],["collettivo","group","Collettivo","Più allievi insieme",C.purple,C.purpleBg,C.purpleBorder]].map(([val,icon,lbl,sub,col,bg,border])=>(
              <button key={val} onClick={()=>set("type",val)} style={{flex:1,padding:"14px 16px",borderRadius:10,border:`2px solid ${f.type===val?col:C.border}`,background:f.type===val?bg:C.bg,cursor:"pointer",display:"flex",alignItems:"center",gap:10,transition:"all 0.15s"}}>
        ...
        <Textarea label="Descrizione (opzionale)" value={f.description} onChange={e=>set("description",e.target.value)} placeholder="Breve descrizione del corso..."/>
                ...
                return (
                  <button key={d.id} onClick={()=>toggleDocente(d.id)}
                    ...
                    <div style={{flex:1,minWidth:0}}>
                      ...
                      <div style={{fontSize:11,color:C.textMuted}}>{Array.isArray(d.strumenti) ? d.strumenti.join(", ") : (d.strumenti||"—")}</div>
                    </div>
...
const CourseDetail = ({ course, students, docenti:_docentiRaw, onBack, onEdit, onDelete }) => {
  ...
  return (
    <div style={{animation:"slideIn 0.25s ease"}}>
      {/* Back */}
      <button onClick={onBack} style={{display:"flex",alignItems:"center",gap:6,background:"none",border:"none",cursor:"pointer",color:C.textMuted,fontSize:13,marginBottom:20,padding:0,fontFamily:"'DM Sans',sans-serif"}}>
      ...
      <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,overflow:"hidden",marginBottom:16}}>
        ...
        {crsDocenti.length === 0 ? (
          <div style={{textAlign:"center",padding:"32px 0",color:C.textDim}}>
            <p style={{fontSize:13}}>Nessun docente assegnato — clicca <strong>Modifica</strong> per assegnarne uno</p>
          </div>
        ) : (
              ...
              {enrolled.map((s,i)=>{
                ...
                return (
                  <tr key={s.id} style={{borderBottom:i<enrolled.length-1?`1px solid ${C.border}`:"none",transition:"background 0.12s"}}
                    ...
                    <td style={{padding:"13px 20px",fontSize:13,color:C.textMuted}}>{s.level||"—"}</td>
                    <td style={{padding:"13px 20px"}}>
                      <div style={{fontSize:14}}>€ {s.monthlyFee}</div>
...
const CourseManager = ({ courses, students, docenti:_docentiRaw, onAdd, onEdit, onDelete }) => {
    ...
    return (
      <>
        <CourseDetail
          ...
          onDelete={()=>{ setTarget(live); setModal("delete"); }}
        />
        {modal==="edit"   && target && <Modal title="Modifica corso" onClose={()=>setModal(null)}><CourseForm initial={target} docenti={docenti} onSave={d=>{onEdit({...target,...d});setSelectedCourse(p=>({...p,...d}));setModal(null);}} onClose={()=>setModal(null)}/></Modal>}
        {modal==="delete" && target && <ConfirmDelete label={target.name} description="Il corso verrà rimosso. Gli allievi iscritti perderanno l'associazione al corso complementare." onConfirm={()=>handleDelete(target.id)} onClose={()=>setModal(null)}/>}
      </>
    );
  }
  ...
  const CourseRow = ({ c, badgeColor }) => {
    ...
    return (
      <div onClick={()=>setSelectedCourse(c)}
        ...
        <div style={{width:38,height:38,borderRadius:8,background:bg,border:`1px solid ${bd}`,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
          <Ic n={badgeColor==="purple"?"group":"solo"} size={16} color={col}/>
        </div>
        <div style={{flex:1,minWidth:0}}>
          <div style={{fontSize:14,fontWeight:500}}>{c.name}</div>
          {c.description && <div style={{fontSize:12,color:C.textMuted,marginTop:2,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{c.description}</div>}
        </div>
        <div style={{display:"flex",alignItems:"center",gap:12,flexShrink:0}}>
          ...
          {(c.docenti||[]).length > 0 && (
            <div style={{display:"flex",alignItems:"center"}}>
              {docenti.filter(d=>(c.docenti||[]).includes(d.id)).slice(0,3).map((d,i)=>(
                <div key={d.id} title={d.nome} style={{width:22,height:22,borderRadius:"50%",background:`${d.colore||C.gold}25`,
              ...
              {(c.docenti||[]).length > 3 && (
                <div style={{width:22,height:22,borderRadius:"50%",background:C.surfaceHover,border:`2px solid ${C.bg}`,
                  display:"flex",alignItems:"center",justifyContent:"center",fontSize:9,color:C.textMuted,marginLeft:-6}}>
                  +{(c.docenti||[]).length-3}
                </div>
              )}
            </div>
          )}
          <span style={{background:bg,border:`1px solid ${bd}`,borderRadius:20,padding:"3px 10px",fontSize:12,color:col,fontWeight:500}}>
            {n} alliev{n===1?"o":"i"}
          </span>
          {/* azioni — stopPropagation per non aprire la scheda */}
          <button onClick={e=>{e.stopPropagation();setTarget(c);setModal("edit");}} style={{background:"none",border:"none",cursor:"pointer",color:C.textMuted,padding:4,display:"flex",borderRadius:6}}
          ...
          <button onClick={e=>{e.stopPropagation();setTarget(c);setModal("delete");}} style={{background:"none",border:"none",cursor:"pointer",color:C.textMuted,padding:4,display:"flex",borderRadius:6}}
  ...
  const SectionTitle = ({ icon, label, count, color }) => (
    <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:10}}>
      ...
      <span style={{fontSize:12,letterSpacing:"0.08em",textTransform:"uppercase",color:C.textMuted}}>{label}</span>
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",gap:24}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
        <div>
          <h1 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:32,fontWeight:600}}>Gestione Corsi</h1>
          <p style={{color:C.textMuted,fontSize:14,marginTop:4}}>{individuali.length} corsi individuali · {collettivi.length} corsi collettivi</p>
        </div>
        <Btn onClick={()=>setModal("add")}><Ic n="plus" size={14} color={C.bg}/>Nuovo corso</Btn>
      </div>
...
const StudentForm = ({ initial, onSave, onClose, courses }) => {
  ...
  return (
    <>
      <div style={{padding:24,display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}} className="form-2col">
        ...
        {/* Corso principale */}
        <div style={{gridColumn:"1/-1"}}>
          <label style={{fontSize:12,color:C.textMuted,letterSpacing:"0.06em",textTransform:"uppercase",display:"block",marginBottom:6}}>Corso principale — strumento *</label>
        ...
        <div style={{gridColumn:"1/-1"}}>
          <label style={{fontSize:12,color:C.textMuted,letterSpacing:"0.06em",textTransform:"uppercase",display:"block",marginBottom:8}}>Corso complementare — collettivo</label>
          {collettivi.length===0
        ...
        <Input label="Quota mensile (€) *" type="number" value={f.monthlyFee} onChange={e=>set("monthlyFee",e.target.value)} error={errors.monthlyFee} placeholder="100"/>
  ...
  return (
    <div>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16}}>
        <h3 style={{fontSize:13,letterSpacing:"0.08em",textTransform:"uppercase",color:C.textMuted}}>Registro Lezioni ({lessons.length})</h3>
        <Btn small onClick={()=>setShowForm(p=>!p)}><Ic n="plus" size={12} color={C.bg}/>Aggiungi</Btn>
      </div>
      {showForm && (
        <div style={{background:C.bg,border:`1px solid ${C.border}`,borderRadius:10,padding:16,marginBottom:16,display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,animation:"fadeIn 0.2s ease"}} className="form-2col">
          <Input label="Data" type="date" value={form.date} onChange={e=>set("date",e.target.value)}/>
          <Sel label="Presenza" value={form.attendance} onChange={e=>set("attendance",e.target.value)} options={["presente","assente","giustificato"]}/>
          <div style={{gridColumn:"1/-1"}}><Input label="Argomento *" value={form.topic} onChange={e=>set("topic",e.target.value)} placeholder="Es. Scale maggiori, Bach Invenzione n.1..."/></div>
          <div style={{gridColumn:"1/-1"}}><Textarea label="Note insegnante" value={form.notes} onChange={e=>set("notes",e.target.value)} placeholder="Osservazioni, compiti per casa..."/></div>
          <div style={{gridColumn:"1/-1",display:"flex",gap:8,justifyContent:"flex-end"}}>
            <Btn small variant="secondary" onClick={()=>setShowForm(false)}>Annulla</Btn>
            <Btn small onClick={handleAdd}><Ic n="check" size={12} color={C.bg}/>Salva lezione</Btn>
          </div>
        </div>
      )}
      {lessons.length===0 && !showForm && <div style={{textAlign:"center",padding:"32px 0",color:C.textDim,fontSize:13}}>Nessuna lezione registrata</div>}
      <div style={{display:"flex",flexDirection:"column",gap:8}}>
        {[...lessons].sort((a,b)=>new Date(b.date)-new Date(a.date)).map((l,i)=>(
          <div key={i} style={{display:"flex",gap:12,padding:"12px 14px",background:C.bg,borderRadius:8,border:`1px solid ${C.border}`}}>
            ...
            <Badge label={l.attendance} color={l.attendance==="presente"?"green":l.attendance==="giustificato"?"gold":"red"}/>
          </div>
        ))}
      </div>
    </div>
...
const StudentDetail = ({ student, courses, lessons:_lessonsRaw, entrate:_allEntrateRaw, setEntrate, annoInizioAttivo, onEdit, onDelete, onBack, onAddLesson, onUpdateStudent, config:propConfig }) => {
  ...
  const MeseSelector = () => (
    <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:10,padding:"12px 16px",marginBottom:20}}>
      <div style={{fontSize:10,color:C.textDim,letterSpacing:"0.1em",textTransform:"uppercase",marginBottom:10}}>
          ...
          return (
            <button key={`${x.y}-${x.m}`} onClick={()=>!isF && setSelMese(x)} disabled={isF}
              style={{padding:"5px 12px",borderRadius:20,fontSize:12,fontWeight:isS?600:400,
                ...
                cursor:isF?"not-allowed":"pointer",opacity:isF?0.4:1,transition:"all 0.15s"}}>
              {MESI_LABEL_S[x.m-1]}
              {hasD && !isF && <span style={{display:"inline-block",width:4,height:4,borderRadius:"50%",
                background:isS?C.bg:accentHex,marginLeft:5,verticalAlign:"middle"}}/>}
            </button>
          );
        })}
      </div>
  ...
  const GraficoAS = () => (
    <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"16px 20px",marginBottom:16}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
        <div style={{fontSize:11,color:C.textMuted,letterSpacing:"0.07em",textTransform:"uppercase"}}>Andamento anno scolastico</div>
      ...
      <div style={{display:"flex",alignItems:"flex-end",gap:4,height:80}}>
        {andamento.map(x => (
          <div key={`${x.y}-${x.m}`} onClick={()=>!x.isFut && setSelMese({m:x.m,y:x.y})}
            style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:4,cursor:x.isFut?"default":"pointer"}}>
            ...
            <div style={{width:"100%",borderRadius:"3px 3px 0 0",minHeight:4,
              ...
              outline:x.isSel?`2px solid ${accentHex}`:"none",outlineOffset:1,transition:"all 0.2s"}}/>
            <div style={{fontSize:9,color:x.isSel?accentHex:C.textDim,textTransform:"uppercase",fontWeight:x.isSel?700:400}}>{x.label}</div>
          </div>
        ))}
      </div>
    </div>
            ...
            {lezSel.length===0 ? (
              ...
              lezSel.slice().sort((a,b)=>a.date.localeCompare(b.date)||a.hour.localeCompare(b.hour)).map((l,i) => (
                <div key={l.id} style={{display:"grid",gridTemplateColumns:"90px 1fr auto",gap:12,alignItems:"center",
                  ...
                  <div>
                    <div style={{display:"flex",alignItems:"center",gap:6}}>
                      <span style={{fontSize:13,fontWeight:500}}>{isColl(l)?l.courseName:l.topic||"—"}</span>
                ...
                {MESI_AS.map((x,i) => {
                  ...
                  return (
                    <tr key={i} onClick={()=>!isF&&setSelMese(x)}
                      ...
                      <td style={{padding:"11px 18px",fontSize:13,color:C.green}}>{isF?"—":pres||"—"}</td>
                      <td style={{padding:"11px 18px",fontSize:13,color:ass>0?C.red:C.textDim}}>{isF?"—":ass||"—"}</td>
              ...
              {repInStudio.map((b,i) => (
                <div key={b.id} style={{padding:"14px 20px",borderBottom:i<repInStudio.length-1?`1px solid ${C.border}`:"none",
                  ...
                  <div>
                    ...
                    <div style={{fontSize:12,color:C.textMuted}}>{b.compositore} · <span style={{color:`${accentHex}cc`,fontStyle:"italic"}}>{b.periodo}</span></div>
              ...
              {repCompletato.map((b,i) => (
                <div key={b.id} style={{padding:"14px 20px",borderBottom:i<repCompletato.length-1?`1px solid ${C.border}`:"none",
                  ...
                  <div>
                    ...
                    <div style={{fontSize:12,color:C.textMuted}}>{b.compositore} · <span style={{fontStyle:"italic"}}>{b.periodo}</span></div>
                    {b.note && <div style={{fontSize:12,color:C.textDim,marginTop:4,fontStyle:"italic"}}>{b.note}</div>}
                  </div>
                  <div style={{textAlign:"right",flexShrink:0}}>
                    <div style={{fontSize:11,color:C.textDim}}>dal {fmtDate(b.dataInizio)}</div>
            ...
            return (
              <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"16px 20px",marginBottom:16}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
                  ...
                  <span style={{fontSize:11,color:C.textDim}}>Totale incassato: €{totAnno.toLocaleString("it-IT")}</span>
                </div>
                <div style={{display:"flex",alignItems:"flex-end",gap:4,height:80}}>
                  {MESI_AS.map((x,i)=>{
                    ...
                    return (
                      <div key={i} onClick={()=>!isF&&setSelMese(x)}
                        ...
                        <div style={{fontSize:9,color:isS?accentHex:C.textDim,fontWeight:isS?700:400}}>{(!isF&&v>0)?`€${v}`:""}</div>
                ...
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,overflow:"hidden",marginBottom:16}}>
                  ...
                  {entSel ? (
                    <div style={{display:"grid",gridTemplateColumns:"80px 1fr auto",gap:12,alignItems:"center",padding:"14px 20px"}}>
                      ...
                      <div style={{display:"flex",alignItems:"center",gap:8}}>
                        <div style={{fontSize:15,fontWeight:600,color:C.green}}>€{entSel.importo}</div>
                  ...
                  return (
                    <tr key={i} onClick={()=>!isF&&setSelMese(x)}
                      ...
                      <td style={{padding:"11px 18px"}}>
                        ...
                        {isF && <span style={{color:C.textDim}}>—</span>}
                      </td>
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",gap:20}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:12}}>
        <div>
          <h1 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(22px,4vw,32px)",fontWeight:600}}>Anagrafica Allievi</h1>
          <p style={{color:C.textMuted,fontSize:14,marginTop:4}}>{students.filter(s=>s.status==="attivo").length} attivi · {students.length} totali</p>
        </div>
                ...
                {filtered.map((s,i)=>{
                  ...
                  return (
                    <tr key={s.id} style={{borderBottom:i<filtered.length-1?`1px solid ${C.border}`:"none",cursor:"pointer",transition:"background 0.12s"}}
                      ...
                      <td className="hide-mobile" style={{padding:"13px 16px"}} onClick={()=>onSelect(s)}>{comp?<Badge label={comp.name} color="purple"/>:<span style={{fontSize:12,color:C.textDim}}>—</span>}</td>
...
const AllieviView = ({ students:propStudents, setStudents:propSetStudents, courses:propCourses, setCourses:propSetCourses, lessons:propLessons, entrate:propEntrate, setEntrate:propSetEntrate, annoInizioAttivo, config:propConfig }) => {
  ...
  const handleEditStudent   = d  => { setStudents(p=>p.map(s=>s.id===d.id?{...s,...d}:s)); if(selected?.id===d.id) setSelected(p=>({...p,...d})); closeModal(); };
  const handleDeleteStudent = () => { setStudents(p=>p.filter(s=>s.id!==selected?.id)); setView("list"); setSelected(null); closeModal(); };
  const handleAddLesson     = (sid,lesson) => {
    setStudents(p=>p.map(s=>s.id===sid?{...s,lessons:[...(s.lessons||[]),lesson]}:s));
    setSelected(p=>p?.id===sid?{...p,lessons:[...(p.lessons||[]),lesson]}:p);
  };

  return (
    <>
      <div style={{maxWidth:1200,margin:"0 auto",padding:"clamp(12px, 3vw, 32px)"}}>
        {view==="list" && (
          <StudentList
      ...
      {modal==="add"    && <Modal title="Nuovo allievo" onClose={closeModal} wide><StudentForm onSave={handleAddStudent} onClose={closeModal} courses={courses}/></Modal>}
      {modal==="edit"   && selected && <Modal title="Modifica allievo" onClose={closeModal} wide><StudentForm initial={students.find(s=>s.id===selected.id)} onSave={handleEditStudent} onClose={closeModal} courses={courses}/></Modal>}
      {modal==="delete" && selected && <ConfirmDelete label={selected.name} description="Questa azione è irreversibile." onConfirm={handleDeleteStudent} onClose={closeModal}/>}
    </>
  );
};
...
const isColl      = l => l?.tipo === "collettivo";
const isProva     = l => l?.tipo === "prova";
const lessonHex   = l => isColl(l) ? C.purple : isProva(l) ? C.teal : insHex(l?.instrument||"");
...
const LessonForm = ({ initial, onSave, onClose, repertorio:_repertorioRaw, onAddBrano }) => {
  ...
  const SDiv = ({ label }) => (
    <div style={{gridColumn:"1/-1", fontSize:10, color:C.textDim, letterSpacing:"0.12em",
      textTransform:"uppercase", paddingBottom:4, borderBottom:`1px solid ${C.border}`, marginTop:4}}>
      {label}
    </div>
  );
  ...
  return (
    <>
      <div style={{padding:22, display:"grid", gridTemplateColumns:"1fr 1fr", gap:14}} className="form-2col">
        <SDiv label="Quando"/>
        <Input label="Data *" type="date" value={f.date} onChange={e => set("date", e.target.value)} error={err.date}/>
        <Sel label="Orario *" value={f.hour} onChange={e => set("hour", e.target.value)} options={hours} error={err.hour}/>
          ...
          <>
                ...
                <select
                  ...
                  {["individuale","collettivo"].map(tipo => {
                    ...
                    return (
                      <optgroup key={tipo} label={tipo === "individuale" ? "── Individuali ──" : "── Collettivi ──"}>
                        {group.map(b => (
      ...
      {(() => {
        ...
        return (
          <div style={{display:"flex", justifyContent:"space-between", alignItems:"flex-start", gap:4}}>
            ...
            {lesson.tipo==="prova" && (
              <span style={{fontSize:9, color:C.teal, fontWeight:700, textTransform:"uppercase", flexShrink:0}}>
                prova{lesson.iscritto ? " \u2713" : ""}
              </span>
            )}
            {lesson.tipo!=="collettivo" && lesson.tipo!=="prova" && lesson.attendance && (
              <div style={{width:6, height:6, borderRadius:"50%", background:dotHex, flexShrink:0, marginTop:2}}/>
            )}
          </div>
        );
      })()}
      ...
      <div style={{padding:22, display:"flex", flexDirection:"column", gap:16}}>
        <div style={{display:"flex", gap:14, alignItems:"center"}}>
          <div style={{width:46, height:46, borderRadius:10,
            ...
            display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0}}>
            <Ic n={lesson.tipo==="collettivo"?"group":lesson.tipo==="prova"?"user":"music"}
               size={20} stroke={lesson.tipo==="collettivo"?C.purple:lesson.tipo==="prova"?C.teal:hex}/>
          </div>
          <div style={{flex:1}}>
            {lesson.tipo==="collettivo" ? (
              <>
                <div style={{fontSize:17, fontWeight:600, fontFamily:"'Cormorant Garamond',serif"}}>{lesson.courseName}</div>
                <div style={{fontSize:13, color:C.purple, marginTop:2}}>Lezione collettiva · {lesson.teacher}</div>
              </>
            ) : lesson.tipo==="prova" ? (
              <>
                <div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}>
                  <div style={{fontSize:17, fontWeight:600, fontFamily:"'Cormorant Garamond',serif", color:C.teal}}>
                    {lesson.contactName || "Lezione di prova"}
                  </div>
                  {lesson.iscritto
                    ? <span style={{fontSize:11,background:C.greenBg,color:C.green,
                        border:`1px solid ${C.greenBorder}`,borderRadius:4,padding:"2px 8px",fontWeight:600}}>
                        Iscritto ✓{lesson.student ? ` — ${lesson.student}` : ""}
                      </span>
                    : <span style={{fontSize:11,background:C.tealBg,color:C.teal,
                        border:`1px solid ${C.tealBorder}`,borderRadius:4,padding:"2px 8px"}}>
                        Non ancora iscritto
                      </span>
                  }
                </div>
                <div style={{fontSize:13, color:C.teal, opacity:0.85, marginTop:2}}>
                  ...
                  {lesson.phone
                    ? <span style={{color:C.textMuted, display:"inline-flex", alignItems:"center", gap:4}}>
                        {" · "}📞 <span style={{color:C.teal,fontWeight:500}}>{lesson.phone}</span>
                      </span>
                    : ""}
                </div>
              </>
              ...
              <>
                <div style={{fontSize:17, fontWeight:600, fontFamily:"'Cormorant Garamond',serif"}}>{lesson.student}</div>
                <div style={{fontSize:13, color:hex, marginTop:2}}>{lesson.instrument}</div>
              </>
            )}
          </div>
          {lesson.recurrence !== "Nessuna" && <Badge label={lesson.recurrence} variant="blue"/>}
          {lesson.tipo==="collettivo" && <Badge label="Collettiva" variant="purple"/>}
          {lesson.tipo==="prova" && <Badge label="Prova" variant="teal"/>}
        </div>
                ...
                return (
                  <div key={id} style={{display:"flex", alignItems:"center", gap:10, padding:"10px 12px",
                    ...
                    <div style={{flex:1, minWidth:0}}>
                      ...
                      <div style={{fontSize:11, color:C.textMuted}}>{b.composer}{b.tonality ? ` · ${b.tonality}` : ""}</div>
                    </div>
                  </div>
                );
              })}
              ...
              <div style={{flex:1}}>
                {nextLessonDate ? (
                  ...
                  <div style={{fontSize:12, color:C.textDim}}>
                    Lezione {lesson.recurrence.toLowerCase()} — la prossima verrà creata segnando la presenza
                  </div>
                )}
              </div>
              {!nextLessonDate && lesson.attendance && (
                <span style={{fontSize:10, color:C.textDim, fontStyle:"italic"}}>già pianificata</span>
              )}
            </div>
          )}
        </div>
              ...
              <div style={{display:"flex", gap:8, alignItems:"center", marginTop:4}}>
                <select value={iscrizioneStudent} onChange={e=>setIscrizioneStudent(e.target.value)}
                  ...
                  {studentsList.filter(s=>s.status==="attivo").map(s=>(
                    <option key={s.id} value={s.name}>{s.name} · {s.instrument}</option>
                  ))}
                ...
                <>
                  <div style={{display:"flex", alignItems:"center", gap:8, marginBottom:4, flexWrap:"wrap"}}>
                    ...
                    <span style={{fontSize:11, background:C.purpleBg, color:C.purple,
                      ...
                      letterSpacing:"0.05em"}}>Collettiva</span>
                    {l.recurrence !== "Nessuna" && <Ic n="repeat" size={12} stroke={C.textDim}/>}
                  </div>
                  <div style={{display:"flex", gap:12, fontSize:12, color:C.textMuted, flexWrap:"wrap"}}>
                    ...
                    <span>· {(l.students||[]).length} allievi</span>
                  </div>
                  {(l.students||[]).length > 0 && (
                    <div style={{display:"flex", gap:5, marginTop:6, flexWrap:"wrap"}}>
                      {(l.students||[]).map(s => (
                        <span key={s.id} style={{fontSize:10, padding:"1px 7px", borderRadius:10,
                  ...
                  {l.topic && <div style={{fontSize:12, color:C.textMuted, marginTop:6, fontStyle:"italic"}}>"{l.topic}"</div>}
                </>
              ) : l.tipo==="prova" ? (
                <>
                  <div style={{display:"flex", alignItems:"center", gap:8, marginBottom:4, flexWrap:"wrap"}}>
                    ...
                    <span style={{fontSize:11, background:C.tealBg, color:C.teal,
                      ...
                      letterSpacing:"0.05em"}}>Prova</span>
                    {l.iscritto
                      ? <span style={{fontSize:11, background:C.greenBg, color:C.green,
                          border:`1px solid ${C.greenBorder}`, borderRadius:4, padding:"1px 7px",fontWeight:600}}>
                          Iscritto ✓
                        </span>
                      : <span style={{fontSize:11, background:C.tealBg, color:C.teal,
                          border:`1px solid ${C.tealBorder}`, borderRadius:4, padding:"1px 7px"}}>
                  ...
                  <div style={{display:"flex", gap:12, fontSize:12, color:C.textMuted, flexWrap:"wrap"}}>
                    ...
                    {l.teacher && <span>· {l.teacher}</span>}
                    {l.room    && <span>· {l.room}</span>}
                    {l.phone   && <span style={{color:C.teal}}>· 📞 {l.phone}</span>}
                  </div>
                  {l.notes && <div style={{fontSize:12, color:C.textMuted, marginTop:6, fontStyle:"italic"}}>{l.notes}</div>}
                </>
              ) : (
                <>
                  <div style={{display:"flex", alignItems:"center", gap:8, marginBottom:4, flexWrap:"wrap"}}>
                    ...
                    {l.recurrence !== "Nessuna" && <Ic n="repeat" size={12} stroke={C.textDim}/>}
                    {dotHex && <div style={{width:7, height:7, borderRadius:"50%", background:dotHex}}/>}
                  </div>
                  <div style={{display:"flex", gap:12, fontSize:12, color:C.textMuted, flexWrap:"wrap"}}>
                    {l.teacher && <span>{l.teacher}</span>}
                    {l.room    && <span>· {l.room}</span>}
    ...
    <div style={{overflowX:"auto",WebkitOverflowScrolling:"touch"}}>
      <div style={{minWidth:480}}>
        ...
        <div style={{display:"grid", gridTemplateColumns:"52px repeat(7,1fr)",
          borderBottom:`1px solid ${C.border}`, position:"sticky", top:0, background:C.surface, zIndex:2}}>
          <div/>
          {days.map((d, i) => {
            const isToday = isSameDay(d, today);
            return (
              <div key={i} style={{padding:"8px 4px", textAlign:"center", borderLeft:`1px solid ${C.border}`, minWidth:0, overflow:"hidden"}}>
                <div style={{fontSize:11, color:C.textMuted, letterSpacing:"0.06em", textTransform:"uppercase"}}>{DAYS_SHORT[i]}</div>
                <div style={{fontFamily:"'Cormorant Garamond',serif", fontSize:20, fontWeight:600, marginTop:2,
        ...
        {HOURS.map(hour => (
          <div key={hour} style={{display:"grid", gridTemplateColumns:"52px repeat(7,1fr)",
            ...
            <div style={{padding:"8px 6px 0", fontSize:11, color:C.textDim, textAlign:"right", paddingRight:8}}>{hour}</div>
            {days.map((d, i) => {
      ...
      <div style={{display:"grid", gridTemplateColumns:"repeat(7,1fr)", borderBottom:`1px solid ${C.border}`}}>
        {DAYS_SHORT.map(d => (
          <div key={d} style={{padding:"8px 0", textAlign:"center", fontSize:11,
            letterSpacing:"0.06em", textTransform:"uppercase", color:C.textMuted}}>{d}</div>
        ))}
      </div>
            ...
            <div key={idx} onClick={() => onDayClick(d)}
              ...
              <div style={{display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:4}}>
                <span style={{fontSize:12, fontWeight:500,
                  ...
                  padding: isToday ? "1px 5px" : undefined}}>
                  {day}
                </span>
...
const BranoFormInline = ({ initial, onSave, onClose, compact=false }) => {
  ...
  return (
    <>
      <div style={{padding:compact?10:22, display:"flex", flexDirection:"column", gap:compact?8:14}}>
        <Input label="Titolo *" value={f.title} onChange={e=>set("title",e.target.value)} error={err.title} placeholder="Es. Notturno Op.9 n.2"/>
        <Input label="Compositore *" value={f.composer} onChange={e=>set("composer",e.target.value)} error={err.composer} placeholder="Es. Frédéric Chopin"/>
        <Sel label="Tonalità / Scala" value={f.tonality} onChange={e=>set("tonality",e.target.value)} options={TONALITY_OPTS}/>
        <Sel label="Livello di difficoltà" value={f.difficulty} onChange={e=>set("difficulty",e.target.value)} options={DIFFICULTY_OPTS}/>
        <div>
          <label style={{fontSize:12, color:C.textMuted, letterSpacing:"0.06em", textTransform:"uppercase", display:"block", marginBottom:8}}>Tipo brano</label>
          <div style={{display:"flex", gap:10}}>
            {[["individuale","solo",C.gold,"#2e2308",C.goldDim],["collettivo","group",C.purple,C.purpleBg,C.purpleBorder]].map(([val,icon,fg,bg,bd]) => (
              <button key={val} onClick={()=>set("type",val)} style={{flex:1, padding:"12px 14px", borderRadius:10,
                ...
                <div style={{textAlign:"left"}}>
                  <div style={{fontSize:13, fontWeight:500, color:f.type===val?fg:C.text, textTransform:"capitalize"}}>{val}</div>
                  <div style={{fontSize:11, color:C.textMuted}}>{val==="individuale"?"Studio personale":"Ensemble / orchestra"}</div>
                </div>
              </button>
            ))}
          </div>
        </div>
        <Textarea label="Note / annotazioni" value={f.notes} onChange={e=>set("notes",e.target.value)} placeholder="Note aggiuntive, indicazioni tecniche..."/>
      </div>
      <div style={{padding:compact?"10px 10px":"14px 22px", borderTop:`1px solid ${C.border}`, display:"flex", justifyContent:"flex-end", gap:8}}>
        <Btn small={compact} variant="secondary" onClick={onClose}>Annulla</Btn>
        <Btn small={compact} onClick={handleSave}><Ic n="check" size={14} stroke={C.bg}/>{initial?.id?"Salva modifiche":"Aggiungi brano"}</Btn>
      </div>
    </>
  );
};
      ...
      <div style={{borderBottom:`1px solid ${C.border}20`}}>
        ...
        <div onClick={() => setExpanded(open ? null : b.id)}
          ...
          <div style={{flex:"0 0 18%", fontSize:12, color:C.textMuted, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap"}}>
            {b.tonality || <span style={{color:C.textDim}}>—</span>}
          </div>
    ...
    return (
      <div style={{background:C.surface, border:`1px solid ${C.border}`, borderRadius:12, overflow:"hidden"}} className="table-scroll">
        ...
        <button onClick={() => setOpen(p => !p)}
          ...
          <span style={{fontSize:12, letterSpacing:"0.08em", textTransform:"uppercase", color:C.textMuted, fontFamily:"'DM Sans',sans-serif"}}>{label}</span>
          <span style={{fontSize:11, color:C.textDim}}>({items.length})</span>
          <div style={{marginLeft:"auto", transition:"transform 0.2s", transform: open ? "rotate(90deg)" : "rotate(0deg)"}}>
            <Ic n="right" size={14} stroke={C.textDim}/>
          </div>
        </button>
        ...
        {open && (
          <>
            ...
            <div style={{display:"flex", alignItems:"center", gap:12, padding:"7px 16px",
              ...
              <div style={{flex:"0 0 18%", fontSize:10, color:C.textDim, letterSpacing:"0.08em", textTransform:"uppercase"}}>Tonalità</div>
              <div style={{flex:"0 0 120px", fontSize:10, color:C.textDim, letterSpacing:"0.08em", textTransform:"uppercase"}}>Difficoltà</div>
...
const CollectiveLessonForm = ({ courses, students, docenti:_docentiRaw, onSave, onClose }) => {
  ...
  const handleSave = () => {
    ...
    onSave({
      ...
      date:       form.date,
      hour:       form.hour,
      teacher:    teacherObj?.nome || teacherObj?.name || "",
            ...
            {collettivi.map(c => {
              ...
              return (
                <button key={c.id} onClick={() => handleCourseSelect(c)}
                  ...
                  <div style={{textAlign:"right", flexShrink:0}}>
                    <div style={{fontSize:16, fontFamily:"'Cormorant Garamond',serif", fontWeight:600,
                      color:nIscritti>0?C.purple:C.textDim}}>{nIscritti}</div>
                    <div style={{fontSize:9, color:C.textDim, textTransform:"uppercase", letterSpacing:"0.06em"}}>allievi</div>
                ...
                return (
                  <button key={s.id} onClick={() => toggleStudent(s.id)}
                    ...
                    <div style={{flex:1}}>
                      ...
                      <div style={{fontSize:11, color:C.textMuted}}>{s.instrument} · {s.level||"—"}</div>
                    </div>
...
const TrialLessonForm = ({ docenti:_docentiRaw, courses:_coursesRaw, initial, onSave, onClose, date }) => {
  ...
  return (
    <>
      <div style={{padding:22, display:"flex", flexDirection:"column", gap:14}}>
        {/* Banner informativo */}
        <div style={{padding:"10px 14px", background:C.tealBg, border:`1px solid ${C.tealBorder}`,
        ...
        <div>
          ...
          <select value={f.teacher} onChange={e=>set("teacher",e.target.value)}
            ...
            {docenti.map(d=>(
              <option key={d.id} value={d.teacherKey||d.nome}>{d.nome} · {d.strumenti}</option>
            ))}
          </select>
        ...
        <div style={{minHeight:"100vh", background:C.bg, display:"flex", flexDirection:"column"}}>
          ...
          <div style={{background:C.surface, borderBottom:`1px solid ${C.border}`,
            ...
            <div style={{display:"flex", alignItems:"center", gap:10, padding:"14px 0"}}>
              ...
              <span style={{fontFamily:"'Cormorant Garamond',serif", fontSize:15, fontWeight:600}}>Accademia Musicale · Calendario</span>
            </div>
          </div>
      ...
      <div style={{padding:22,display:"flex",flexDirection:"column",gap:14}}>
        ...
        {f.categoria==="docenti" && (
          <Sel label="Docente" value={f.docenteId} onChange={e=>{ set("docenteId",e.target.value); const d=DOCENTI.find(x=>x.id===e.target.value); if(d) set("desc",`Compenso mensile ${d.name}`); }}
            options={[{value:"",label:"— seleziona docente —"},...DOCENTI.map(d=>({value:d.id,label:d.name}))]}/>
        )}
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))",gap:12}} className="form-2col">
          <Input label="Importo (€) *" type="number" value={f.importo} onChange={e=>set("importo",e.target.value)} error={err.importo} placeholder="0.00"/>
...
const DocenteView = ({ docente, spese, onBack }) => {
  ...
  return (
    <div>
      <button onClick={onBack} style={{display:"flex",alignItems:"center",gap:6,background:"none",
        border:"none",cursor:"pointer",color:C.textMuted,fontSize:13,marginBottom:20,padding:0,fontFamily:"'DM Sans',sans-serif"}}>
            ...
            {datiMesi.map((d,i)=>{
              ...
              return (
                <tr key={i} style={{borderBottom:`1px solid ${C.border}20`,
                  ...
                  <td style={{padding:"10px 16px",fontFamily:"'Cormorant Garamond',serif",fontSize:15,fontWeight:600,color:d.entrate>0?C.green:C.textDim}}>{d.entrate>0?fmt(d.entrate):"—"}</td>
                  <td style={{padding:"10px 16px",fontFamily:"'Cormorant Garamond',serif",fontSize:15,fontWeight:600,color:d.uscite>0?C.red:C.textDim}}>{d.uscite>0?fmt(d.uscite):"—"}</td>
                  <td style={{padding:"10px 16px",fontFamily:"'Cormorant Garamond',serif",fontSize:15,fontWeight:600,
                    color:sl>0?C.green:sl<0?C.red:C.textDim}}>{(d.entrate>0||d.uscite>0)?fmt(sl):"—"}</td>
                </tr>
              );
            })}
            <tr style={{borderTop:`2px solid ${C.border}`,background:C.bg}}>
      ...
      <div style={{padding:22,display:"flex",flexDirection:"column",gap:14}}>
        ...
        <div>
          ...
          <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
            {CAT_ENTRATE.map(c=>{
              ...
              return (
                <button key={c.id} onClick={()=>{set("categoria",c.id); if(!c.student){set("studentId","");}}}
                  style={{display:"flex",alignItems:"center",gap:6,padding:"7px 14px",borderRadius:20,
                    ...
                    fontFamily:"'DM Sans',sans-serif",fontWeight:isS?600:400,transition:"all 0.12s"}}>
        ...
        {(!needStudent || f.categoria==="altro") && (
          <Input label="Descrizione *" value={f.desc} onChange={e=>set("desc",e.target.value)}
            error={err.desc} placeholder={`Es. ${catObj.label}…`}/>
        )}
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))",gap:12}} className="form-2col">
          ...
          <Input label="Anno" type="number" value={f.anno} onChange={e=>set("anno",Number(e.target.value))}/>
          <Input label="Importo (€) *" type="number" value={f.importo} onChange={e=>set("importo",e.target.value)} error={err.importo}/>
          <Input label="Data *" type="date" value={f.data} onChange={e=>set("data",e.target.value)} error={err.data}/>
        </div>
        <Sel label="Metodo di pagamento" value={f.metodo} onChange={e=>set("metodo",e.target.value)} options={METODI_PAG}/>
        <Textarea label="Note" value={f.note} onChange={e=>set("note",e.target.value)} placeholder="Note aggiuntive..."/>
...
const Navbar = ({ tab, setTab, onSelDoc, onSetModal, onSetModalQuota }) => (
  <div style={{background:C.surface, borderBottom:`1px solid ${C.border}`,
    ...
    <div style={{display:"flex",alignItems:"center",gap:8,paddingRight:20,marginRight:8,
      ...
      <span style={{fontFamily:"'Cormorant Garamond',serif",fontSize:14,fontWeight:600,color:C.gold}}>Contabilità</span>
    </div>
    {[
                      ...
                      <div key={s.id} style={{display:"grid",gridTemplateColumns:"auto 2fr 1fr 1fr 1fr auto",minWidth:520,
                        ...
                        <div>
                          ...
                          <div style={{fontSize:11,color:C.textMuted,marginTop:1}}>
                            ...
                            {doc && <> · <span style={{color:cat.hex}}>{doc.name}</span></>}
                            {s.note && <> · {s.note}</>}
                          </div>
                        </div>
                        {/* Mese */}
              ...
              return (
                <div style={{display:"flex",flexDirection:"column",gap:16}}>
                      ...
                      <tbody>
                        {stSummary.map((s,i)=>(
                          <tr key={s.id} style={{borderBottom:i<stSummary.length-1?`1px solid ${C.border}20`:"none",
                            ...
                            <td style={{padding:"12px 18px",fontFamily:"'Cormorant Garamond',serif",fontSize:16,fontWeight:600,color:C.gold}}>€{s.monthlyFee}</td>
                  ...
                  <div style={{display:"flex",gap:10,flexWrap:"wrap",alignItems:"center"}}>
                    ...
                    <span style={{fontSize:12,color:C.textDim}}>{qFiltrate.length} entrate · {fmt(totQFiltrate)}</span>
                  </div>
                  ...
                  <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,overflow:"hidden"}}>
                    ...
                    {qFiltrate.length===0?(
                      ...
                      <div key={e.id} style={{display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1fr 100px auto",minWidth:520,
                        ...
                        <div>
                          <div style={{fontSize:13,fontWeight:500}}>{e.desc||e.studentName||"—"}</div>
                          {e.numRicevuta&&<div style={{fontSize:11,color:C.gold,marginTop:1,fontFamily:"'Cormorant Garamond',serif",letterSpacing:"0.05em"}}>Ric. n° {e.numRicevuta}</div>}
  ...
  return(
    <>
      <div style={{padding:"20px 22px",display:"flex",flexDirection:"column",gap:14,overflow:"auto"}}>
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))",gap:12}} className="form-2col">
          <div style={{gridColumn:"1/-1"}}>
            <Field label="Titolo *" value={f.title} onChange={e=>set("title",e.target.value)} error={err.title} placeholder="Es. Notturno Op.9 n.2"/>
          </div>
          <Field label="Compositore *" value={f.composer} onChange={e=>set("composer",e.target.value)} error={err.composer} placeholder="Es. Chopin"/>
          <Sel label="Periodo" value={f.periodo} onChange={e=>set("periodo",e.target.value)}
            options={PERIODI.map(p=>({value:p.id,label:p.id}))}/>
          <Sel label="Tonalità / Scala" value={f.tonality} onChange={e=>set("tonality",e.target.value)} options={TONALITY_OPTS}/>
          <Sel label="Difficoltà" value={f.difficulty} onChange={e=>set("difficulty",e.target.value)}
...
const BranoDrawer = ({brano,onClose,onEdit,onDelete})=>{
  ...
  return(
    <>
      ...
      <div style={{position:"fixed",top:0,right:0,bottom:0,zIndex:301,width:480,
        background:C.surface,borderLeft:`1px solid ${C.border}`,
...
const AllievoBraniView = ({allievo,brani,onBack})=>{
  ...
  return(
    <div style={{flex:1,padding:isMobile?"12px":"20px 24px",overflow:"auto"}}>
      <button onClick={onBack} style={{display:"flex",alignItems:"center",gap:6,background:"none",
              ...
              return(
                <div key={b.id} style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:10,
                  ...
                  <div style={{flex:1,minWidth:0}}>
                    ...
                    <div style={{fontSize:12,color:C.textMuted}}>{b.composer}{b.tonality?` · ${b.tonality}`:""}</div>
                  </div>
        ...
        <div style={{minHeight:"100vh",background:C.bg,display:"flex",flexDirection:"column"}}>
          ...
          <header style={{background:C.surface,borderBottom:`1px solid ${C.border}`,
            ...
            {[["grid2","Dashboard"],["users","Allievi"],["calendar","Calendario"],
              ["shield","Contabilità"],["book","Repertorio"],["users","Utenti"]].map(([ic,lb],i)=>(
...
const PrenotazioneForm = ({ evento, initial, onSave, onClose }) => {
  ...
  const postiGia = evento.prenotazioni
    .filter(p=>p.stato==="confermata"&&p.id!==(initial?.id||""))
    .reduce((t,p)=>t+p.posti,0);
  const postiLib = Math.max(0, evento.capienza - postiGia);
  const importo  = f.posti*(evento.prezzoBiglietto||0);
  return (
    <>
      <div style={{padding:"20px 24px",display:"flex",flexDirection:"column",gap:14,overflow:"auto"}}>
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(190px,1fr))",gap:12}}>
          <Input label="Nome *" value={f.nome} onChange={e=>set("nome",e.target.value)} placeholder="Nome e cognome"/>
          <Input label="Email" type="email" value={f.email} onChange={e=>set("email",e.target.value)} placeholder="email@esempio.it"/>
          <Input label="Telefono" value={f.telefono} onChange={e=>set("telefono",e.target.value)} placeholder="333 0000000"/>
          <Input label={`Posti (max ${postiLib})`} type="number" value={f.posti}
            onChange={e=>set("posti",Math.min(postiLib,Math.max(1,+e.target.value)))}/>
          <Sel label="Stato" value={f.stato} onChange={e=>set("stato",e.target.value)} options={["confermata","in attesa","annullata"]}/>
          <Sel label="Pagamento" value={f.pagato?"pagato":"da pagare"} onChange={e=>set("pagato",e.target.value==="pagato")} options={["pagato","da pagare"]}/>
        </div>
        {evento.biglietto && (
          <div style={{background:C.goldBg,border:`1px solid ${C.goldDim}`,borderRadius:8,padding:"12px 16px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            <span style={{fontSize:12,color:C.textMuted}}>Importo da riscuotere</span>
            <span style={{fontFamily:"'Cormorant Garamond',serif",fontSize:22,fontWeight:600,color:C.gold}}>€ {importo.toFixed(2)}</span>
          </div>
        )}
      </div>
      <div style={{padding:"14px 24px",borderTop:`1px solid ${C.border}`,display:"flex",justifyContent:"flex-end",gap:10}}>
        <Btn variant="secondary" onClick={onClose}>Annulla</Btn>
        <Btn onClick={()=>{if(!f.nome.trim())return alert("Nome obbligatorio");onSave({...f,id:f.id||uid()});}}>
          <Ic n="check" size={14} stroke={C.bg}/>{initial?.id?"Salva":"Aggiungi"}
        </Btn>
      </div>
    </>
  );
        ...
        <div style={{display:"flex",alignItems:"flex-start",gap:12,marginBottom:12,flexWrap:"wrap"}}>
          ...
          <div style={{flex:1,minWidth:0}}>
            <div style={{display:"flex",alignItems:"center",gap:6,flexWrap:"wrap",marginBottom:4}}>
              ...
              {evento.biglietto && (
                <span style={{padding:"3px 10px",borderRadius:12,background:C.goldBg,color:C.gold,
                  fontSize:10,fontWeight:700,border:`1px solid ${C.goldDim}`}}>€ {evento.prezzoBiglietto} / biglietto</span>
              )}
            </div>
            ...
            <div style={{fontSize:12,color:C.textMuted,marginTop:4,display:"flex",gap:12,flexWrap:"wrap"}}>
              {evento.data  && <span style={{display:"flex",alignItems:"center",gap:4}}><Ic n="calendar" size={11} stroke={C.textDim}/>{formatData(evento.data)}{evento.ora&&` · ${evento.ora}`}</span>}
...
const ConcertiView = ({ students:propStudents }) => {
  ...
  const handleSave   = ev => { setConcerti(p=>[...p.filter(x=>x.id!==ev.id),ev]); setModal(null); if(selected?.id===ev.id) setSelected(ev); };
  ...
  if(selected) return (
    <>
      ...
      {modal==="edit" && (
        <Modal title="Modifica evento" onClose={()=>setModal(null)} wide>
          <EventoForm initial={selected} students={students} onSave={handleSave} onClose={()=>setModal(null)}/>
        </Modal>
      )}
      {modal==="del" && selected && (
        <ConfirmDelete label={selected.titolo} description="Tutte le prenotazioni associate verranno eliminate."
  ...
  return (
    <div style={{padding:isMobile?"12px":"clamp(16px,3vw,28px)",display:"flex",flexDirection:"column",gap:20}}>
      ...
      <div style={{display:"flex",gap:10,flexWrap:"wrap",alignItems:"center"}}>
        <div style={{position:"relative",flex:"1 1 180px"}}>
          ...
          <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="Cerca eventi…"
            style={{width:"100%",background:C.surface,border:`1px solid ${C.border}`,borderRadius:8,
...
const UtenteDrawer = ({utente,onClose,onSave,onSospendi,onElimina,isCurrentAdmin})=>{
  ...
  return(
    <>
      <div onClick={onClose} style={{position:"fixed",inset:0,zIndex:300,
        background:"rgba(0,0,0,.7)",backdropFilter:"blur(3px)",animation:"fadeIn .2s ease"}}/>
      <div style={{position:"fixed",top:0,right:0,bottom:0,zIndex:301,width:500,
        background:C.surface,borderLeft:`1px solid ${C.border}`,
        display:"flex",flexDirection:"column",animation:"slideDrawer .26s cubic-bezier(.4,0,.2,1)"}}>
                ...
                <div key={i} style={{padding:"11px 14px",background:C.bg,border:`1px solid ${C.border}`,
                  ...
                  <div style={{flex:1}}>
                    ...
                    <div style={{fontSize:11,color:C.textDim,marginTop:2,display:"flex",gap:10,flexWrap:"wrap"}}>
                      <span>{a.data}</span>
                      <span>·</span><span>{a.dispositivo}</span>
                      <span>·</span><span style={{fontFamily:"monospace",fontSize:10}}>{a.ip}</span>
                    </div>
                  </div>
                </div>
              ))}
  ...
  return(
    <Modal title="Invita nuovo utente" onClose={onClose} wide>
      <div style={{padding:"20px 22px",display:"flex",flexDirection:"column",gap:14}}>
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))",gap:12}} className="form-2col">
          <Field label="Nome completo *" value={f.nome} onChange={e=>set("nome",e.target.value)} error={err.nome} placeholder="Es. Mario Rossi"/>
          <Field label="Email *" type="email" value={f.email} onChange={e=>set("email",e.target.value)} error={err.email} placeholder="mario@esempio.it"/>
        </div>
        {/* Selezione ruolo */}
        <div>
          <div style={{fontSize:11,color:C.textMuted,letterSpacing:"0.07em",textTransform:"uppercase",marginBottom:9}}>Ruolo assegnato</div>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:7}} className="form-2col">
            {RUOLI.map(r=>(
              <button key={r.id} onClick={()=>set("ruolo",r.id)}
        ...
        <div style={{background:C.blueBg,border:`1px solid ${C.blueBorder}`,borderRadius:9,padding:"11px 14px"}}>
          <div style={{fontSize:11,color:C.blue,marginBottom:5,fontWeight:500}}>Link di invito (verrà inviato via email)</div>
          <div style={{fontSize:11,color:C.textDim,fontFamily:"monospace",
            background:C.bg,padding:"6px 10px",borderRadius:6,wordBreak:"break-all"}}>
            https://accademia.it/accesso?token=inv_{Math.random().toString(36).slice(2,10)}
          </div>
        </div>
        <div style={{display:"flex",flexDirection:"column",gap:5}}>
          <label style={{fontSize:11,color:C.textMuted,letterSpacing:"0.07em",textTransform:"uppercase"}}>Messaggio personalizzato (opzionale)</label>
          <textarea value={f.messaggio} onChange={e=>set("messaggio",e.target.value)} rows={2}
    ...
    <Modal title="Richiesta di accesso" onClose={onClose} wide>
      <div style={{padding:"20px 22px",display:"flex",flexDirection:"column",gap:16}}>
        <div style={{display:"flex",alignItems:"center",gap:13}}>
          <Avatar initials={richiesta.nome.split(" ").map(p=>p[0]).join("").slice(0,2)} hex={r.hex} size={48}/>
          <div>
        ...
        <div style={{background:C.bg,border:`1px solid ${C.border}`,borderRadius:9,padding:"12px 14px"}}>
          <div style={{fontSize:11,color:C.textMuted,marginBottom:6,letterSpacing:"0.07em",textTransform:"uppercase"}}>Messaggio</div>
          <div style={{fontSize:13,color:C.text,lineHeight:1.55}}>{richiesta.messaggio}</div>
        </div>
        <div>
          <div style={{fontSize:11,color:C.textMuted,letterSpacing:"0.07em",textTransform:"uppercase",marginBottom:9}}>Assegna ruolo</div>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:7}} className="form-2col">
            {RUOLI.map(r=>(
      ...
      <div style={{padding:"13px 22px",borderTop:`1px solid ${C.border}`,display:"flex",justifyContent:"space-between",gap:8}}>
...
const ConfirmModal=({titolo,testo,onConfirm,onClose,danger=true})=>(
  <Modal title={titolo} onClose={onClose}>
    <div style={{padding:"22px 22px 14px",display:"flex",flexDirection:"column",gap:14,alignItems:"center",textAlign:"center"}}>
      <div style={{width:50,height:50,borderRadius:"50%",background:danger?C.redBg:C.orangeBg,
    ...
    <div style={{padding:"14px 22px",borderTop:`1px solid ${C.border}`,display:"flex",justifyContent:"center",gap:10}}>
      <Btn variant="secondary" onClick={onClose}>Annulla</Btn>
        ...
        <div style={{minHeight:"100vh",background:C.bg,display:"flex",flexDirection:"column"}}>
          ...
          <header style={{background:C.surface,borderBottom:`1px solid ${C.border}`,
            ...
            {[["grid","Dashboard"],["users","Allievi"],["calendar","Calendario"],
              ["euro","Contabilità"],["music","Repertorio"],["shield","Utenti"]].map(([ic,lb],i)=>(
...
const DocentiView = ({ students:_studentsRaw, lessons:_lessonsRaw, docenti, setDocenti, annoInizioAttivo }) => {
  ...
  const saveDoc  = () => {
    ...
    if(modal==="edit") { setDocenti(p=>p.map(d=>d.id===draft.id?{...draft}:d)); if(selected?.id===draft.id) setSelected({...draft}); }
    setModal(null);
  };
  ...
  const formModalJSX = (modal && modal !== "del") ? (
    <Modal title={modal==="new"?"Nuovo docente":"Modifica docente"} onClose={()=>setModal(null)} wide>
      <div style={{padding:24,display:"flex",flexDirection:"column",gap:16}}>
        <div className="form-2col">
          <Input label="Nome completo *" value={draft.nome||""} onChange={e=>setDraft(p=>({...p,nome:e.target.value}))} placeholder="Prof. Nome Cognome"/>
          <Input label="Email" type="email" value={draft.email||""} onChange={e=>setDraft(p=>({...p,email:e.target.value}))} placeholder="nome@accademia.it"/>
          <Input label="Telefono" value={draft.phone||""} onChange={e=>setDraft(p=>({...p,phone:e.target.value}))} placeholder="333 0000000"/>
          <Input label="Strumenti" value={draft.strumenti||""} onChange={e=>setDraft(p=>({...p,strumenti:e.target.value}))} placeholder="Pianoforte · Chitarra"/>
          <Input label="Tariffa oraria (€)" type="number" value={draft.tariffaOra||35} onChange={e=>setDraft(p=>({...p,tariffaOra:+e.target.value}))}/>
          <Sel label="Tipo contratto" value={draft.contratto||""} onChange={e=>setDraft(p=>({...p,contratto:e.target.value}))}
            options={["Tempo indeterminato","Tempo determinato","Collaborazione","Partita IVA"]}/>
          <Input label="Data inizio" type="date" value={draft.dataInizio||""} onChange={e=>setDraft(p=>({...p,dataInizio:e.target.value}))}/>
        </div>
        <Textarea label="Biografia" value={draft.bio||""} onChange={e=>setDraft(p=>({...p,bio:e.target.value}))} placeholder="Formazione, esperienza..."/>
      </div>
      <div style={{padding:"14px 24px",borderTop:`1px solid ${C.border}`,display:"flex",justifyContent:"flex-end",gap:10}}>
  ...
  // ── VISTA LISTA ──────────────────────────────────────────────────────────────
  if (!selected) return (
    <div style={{maxWidth:1100,margin:"0 auto",padding:"clamp(12px, 3vw, 32px)"}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:28}}>
        <div>
          <h1 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:32,fontWeight:600,lineHeight:1}}>Docenti</h1>
        ...
        {MESI_AS.map(x=>{
          ...
          return (
            <button key={`${x.y}-${x.m}`} onClick={()=>!isF&&setSelMese(x)}
              ...
              {MESI_LABEL_S[x.m-1]}
              {hasD && !isF && <span style={{display:"inline-block",width:4,height:4,borderRadius:"50%",
                background:isS?C.bg:selected.colore,marginLeft:5,verticalAlign:"middle"}}/>}
            </button>
          );
        })}
      </div>
  ...
  const GraficoAS = ({tipo="lezioni"}) => (
    <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"16px 20px",marginBottom:16}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
        <div style={{fontSize:11,color:C.textMuted,letterSpacing:"0.07em",textTransform:"uppercase"}}>
        ...
        {andamento.map(x=>(
          <div key={`${x.y}-${x.m}`} onClick={()=>!x.isFut&&setSelMese({m:x.m,y:x.y})}
            style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:4,
              cursor:x.isFut?"default":"pointer"}}>
            ...
            <div style={{width:"100%",borderRadius:"3px 3px 0 0",
              ...
              outline: x.isSel ? `2px solid ${selected.colore}` : "none", outlineOffset:1}}/>
            <div style={{fontSize:9,color:x.isSel?selected.colore:C.textDim,textTransform:"uppercase",
    ...
    <div style={{maxWidth:1100,margin:"0 auto",padding:"clamp(12px, 3vw, 32px)"}}>
      <button onClick={()=>setSelected(null)}
        style={{display:"flex",alignItems:"center",gap:6,background:"none",border:"none",
          cursor:"pointer",color:C.textMuted,fontSize:13,fontFamily:"'DM Sans',sans-serif",marginBottom:20,padding:0}}>
          ...
          <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,overflow:"hidden"}}>
            <div style={{padding:"14px 20px",borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <div style={{display:"flex",alignItems:"center",gap:8}}>
                ...
                <span style={{fontSize:12,letterSpacing:"0.08em",textTransform:"uppercase",color:C.textMuted}}>
                  Allievi — {MESI_LABEL_L[selMese.m-1]} {selMese.y}
                </span>
              </div>
              <span style={{fontSize:12,color:C.textDim}}>
              ...
              all.map((s,i)=>{
                ...
                return (
                  <div key={s.id} style={{display:"flex",alignItems:"center",gap:14,
                    ...
                    <div style={{flex:1}}>
                      <div style={{fontSize:14,fontWeight:500}}>{s.name}</div>
                      <div style={{fontSize:12,color:C.textMuted,marginTop:2}}>{s.instrument} · {s.level}</div>
                    </div>
                    ...
                    <div style={{textAlign:"right",flexShrink:0}}>
                      <div style={{fontSize:13,fontWeight:600,color:C.gold}}>€{s.monthlyFee}/mese</div>
                    </div>
                  </div>
                );
              })
              ...
              {MESI_AS.map((x,i)=>{
                ...
                return (
                  <div key={i} onClick={()=>!isF&&setSelMese(x)}
                    ...
                    <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:22,fontWeight:600,color:isF?C.textDim:n>0?selected.colore:C.textDim}}>{isF?"—":n}</div>
            ...
            <table style={{width:"100%",borderCollapse:"collapse"}}>
              ...
              <tfoot>
                <tr style={{borderTop:`2px solid ${C.border}`,background:C.bg}}>
                  ...
                  <td style={{padding:"11px 18px",fontSize:12,color:C.textDim}}>—</td>
                </tr>
              </tfoot>
            </table>
          </div>
        ...
        <div>
          ...
          <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,overflow:"hidden",marginBottom:16}}>
            <div style={{padding:"14px 20px",borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              ...
              <span style={{fontSize:13,color:C.green,fontWeight:600}}>€{stipSel.toLocaleString("it-IT")}</span>
            </div>
            {lezSel.length===0 ? (
              <div style={{textAlign:"center",padding:"32px 0",color:C.textDim,fontSize:13}}>
              ...
              lezSel.slice().sort((a,b)=>a.date.localeCompare(b.date)).map((l,i)=>(
                <div key={l.id} style={{display:"grid",gridTemplateColumns:"90px 1fr auto",gap:12,alignItems:"center",
                  ...
                  <div>
                    ...
                    <div style={{fontSize:11,color:C.textMuted}}>{l.topic||"—"}</div>
                  </div>
                  <div style={{textAlign:"right",display:"flex",alignItems:"center",gap:8}}>
                    <div style={{fontSize:13,fontWeight:600,color:C.green}}>€{selected.tariffaOra}</div>
...
const Sidebar = ({ current, setView, user, onLogout }) => {
  ...
  const ini = user?.nome ? user.nome.split(" ").map(p=>p[0]).join("").slice(0,2).toUpperCase() : "??";
  // Primary nav items shown in bottom bar (most used)
  const BOTTOM_ITEMS = NAV_ITEMS.slice(0, 5);
  return (
    <>
      {/* ── Desktop sidebar ── */}
      <div className="sidebar-desktop" style={{width:220,background:C.surface,borderRight:`1px solid ${C.border}`,
        ...
        <div style={{padding:"18px 16px",borderBottom:`1px solid ${C.border}`,flexShrink:0}}>
          <div style={{display:"flex",alignItems:"center",gap:10}}>
            ...
            <div>
              <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:14,fontWeight:600,lineHeight:1.2}}>
                Accademia Musicale
              </div>
              <div style={{fontSize:9,color:C.textDim,letterSpacing:"0.1em",textTransform:"uppercase",marginTop:1}}>
                gestionale
              </div>
            </div>
          </div>
        ...
        <div style={{padding:"12px 14px",borderTop:`1px solid ${C.border}`,flexShrink:0}}>
          <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:10}}>
            ...
            <div style={{flex:1,minWidth:0}}>
              ...
              <div style={{fontSize:10,color:ruoloHex,textTransform:"capitalize",marginTop:1}}>
                {user?.ruolo || "—"}
              </div>
            </div>
          </div>
  ...
  return (
    <>
      <button onClick={()=>setOpen(v=>!v)}
        ...
        <span style={{fontSize:9,letterSpacing:"0.04em",fontFamily:"'DM Sans',sans-serif",
          fontWeight:activeExtra?600:400,textTransform:"uppercase"}}>Altro</span>
      </button>
      {open && (
        <div style={{position:"fixed",bottom:60,left:0,right:0,zIndex:400,
          background:C.surface,borderTop:`1px solid ${C.border}`,
          padding:"8px 0",boxShadow:"0 -4px 20px rgba(0,0,0,0.5)"}}>
          {extraItems.map(item => {
            const active = current === item.id;
            return (
      ...
      <>
        ...
        <div style={{minHeight:"100vh",display:"flex",background:C.bg,overflow:"hidden"}}>
          ...
          <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",
            ...
            <div key={panKey} style={{width:"100%",maxWidth:400,padding:"0 4px"}}>
              {schermata==="login" && (
                <FormLogin
              ...
              {schermata==="register" && <FormRegistrazione onBack={()=>cambiaSchermata("login")}/>}
              {schermata==="recover"   && <FormRecupero onBack={()=>cambiaSchermata("login")}/>}
            </div>
          </div>
        </div>
      </>
  ...
  return (
    <>
      ...
      <div style={{display:"flex",height:"100vh",overflow:"hidden"}}>
        ...
        <div key={view} className="main-scroll" style={{flex:1,overflow:"auto",background:C.bg,animation:"fadeIn 0.25s ease",
          paddingBottom:"calc(env(safe-area-inset-bottom, 0px) + 4px)",minWidth:0}}>
          {views[view]}
        </div>
      </div>
    </>
