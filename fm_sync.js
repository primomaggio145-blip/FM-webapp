...
(function () {
  ...
  function adaptLezione(r, allegatiAll) {
    ...
    return {
      ...
      extraDaDecidere: r.extra_da_decidere || false,
      extraDataPotenziale: r.extra_data_potenziale || null,
      extraDecisione: r.extra_decisione || null,
  ...
  const toDB = {
    studenti(s) {
      return {
        ...
        nome_ricevuta: s.nomeRicevuta || null,
    ...
    lezioni(l) {
      return {
        ...
        extra_da_decidere: l.extraDaDecidere || false,
        extra_data_potenziale: l.extraDataPotenziale || null,
        extra_decisione: l.extraDecisione || null,
